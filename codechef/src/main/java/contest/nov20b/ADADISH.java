...
public class ADADISH {
  ...
  private static int solve(int[] data, int cap) {

    int[][] dp = new int[data.length + 1][cap + 1];
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < testCases; i++) {
      ...
      int bag = solve(arr, sum / 2);

      print.printLine(Integer.toString(Math.max(bag, sum - bag)));
