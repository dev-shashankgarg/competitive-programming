...
// b1
//      if (n % 2 == 0 || data[n / 2] != '0' || count == 1) {
//        print.printLine("BOB");
//      } else {
//        print.printLine("ALICE");
//      }
//
      print.printLine(solve(data, count));
    });
  ...
  private static String solve(char[] data, int count) {
    int mismatch = 0;
    int n = data.length;
